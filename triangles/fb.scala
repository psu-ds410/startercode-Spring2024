...
object FB {
    ...
    ******************************************************************/
    ...
    def makeNonRedundant(edgeList: RDD[(String, String)]): RDD[(String, String)] = {
        ...
        //TODO    
        sc.parallelize(List(("1", "2"))) // just so we have the right return type (remove later)
    } 
    def makeRedundant(edgeList: RDD[(String, String)]): RDD[(String, String)] = {
        //TODO use (1) flatMap (2) wide dependency operation
        ...
        //hint: use flatMap to do the oppositve of canonical representation (what are the
        // edges represented by the canonical form (1, 2)?
